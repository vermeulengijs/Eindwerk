...
// VIA IP adress en URL kunnen we connecteren met de server en kunnen we een GET request doen en krijgen we de data dat we verwachten
...
//IPAddress server ( 104, 27, 152, 209 );  // ip van de jason test server
char Servername[] = "jsonplaceholder.typicode.com";
  ...
  */
  ...
  // Als we een connectie kunnen maken
    ...
    if ( a == 1 )
    {
      ...
      client.println("GET /todos?userId=1&id=1 HTTP/1.1");
